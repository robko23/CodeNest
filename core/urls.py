...
urlpatterns = [
    ...
    path("repository/<str:namespace>/<str:slug>/", views.repo_detail, {"ref": None, "path": ""},
         name="repo_detail"),
    path("repository/<str:namespace>/<str:slug>/refs/<str:ref>/", views.repo_detail, {"path": ""},
         name="repo_detail"),
    path("repository/<str:namespace>/<str:slug>/refs/<str:ref>/<path:path>", views.repo_detail,
         name="repo_detail"),
